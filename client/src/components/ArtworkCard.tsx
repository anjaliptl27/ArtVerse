...
const ArtworkCard = ({
  ...
  return (
    <div className="border rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300 relative">
      {/* Wishlist button */}
      <button
        onClick={(e) => {
          e.stopPropagation();
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-gray-500">
            {artwork.stats.views} views • {artwork.stats.likes} likes
          </span>
        </div>
