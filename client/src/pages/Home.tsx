...
import { FaArrowRight, FaChevronDown, FaChevronUp, FaUserTie } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
         <div>
              ...
              <p className="mt-2 text-gray-500">Curated collection from our talented artists</p>
            </div>
          <Link
            to="/artworks"
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
         <div>
              ...
              <p className="mt-2 text-gray-500">Learn from the best artists in the industry</p>
            </div>
          <Link
            to="/courses"
            className="text-indigo-600 hover:text-indigo-500 flex items-center"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 mt-5">
            <h2 className="text-3xl font-bold text-red-400">
              Meet Our <span className="text-indigo-500">Talented Artists</span>
            </h2>
            <p className="mt-4 max-w-2xl text-xl text-indigo-400 mx-auto">
          ...
          <div className="mt-12 text-center">
            <Link
              to="/artists"
              className="inline-flex items-center px-8 py-3 mb-3 border border-transparent text-lg font-bold rounded-lg shadow-lg text-indigo-700 bg-white hover:bg-indigo-50 transition-colors"
            >
            ...
            {/* Commission CTA Section - Enhanced with illustration */}
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-indigo-50 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Need <span className="text-indigo-600">Custom Artwork</span>?
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                Commission an artist to create a unique piece just for you. Perfect for gifts, home decor, or special occasions.
              </p>
            ...
            <div className="md:w-1/2 bg-white p-6 rounded-lg shadow-md">
              <div className="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-lg p-8 text-center">
                <FaUserTie className="mx-auto h-16 w-16 text-indigo-500 mb-4" />
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Commission Process</h3>
                <ul className="text-left text-gray-600 space-y-2">
                  <li className="flex items-start">
                    <span className="text-indigo-500 mr-2">1.</span> Browse artists and portfolios
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-500 mr-2">2.</span> Submit your request
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-500 mr-2">3.</span> Artist creates your custom piece
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-500 mr-2">4.</span> Receive your unique artwork
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className="bg-indigo-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-xl text-indigo-100">
            {isAuthenticated
              ? "Browse our collection of unique artworks from talented artists worldwide."
