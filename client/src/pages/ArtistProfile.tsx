...
const ArtistProfile = () => {
  ...
  const handleAvatarUpload = async (avatarUrl: string) => {
    try {
      ...
      // Update both userData and formData states
      setUserData((prev) =>
        prev
          ? {
              ...prev,
            ...
            <div className="flex items-center space-x-5">
              <div className="flex-shrink-0 relative">
                {userData?.profile.avatar ? (
                  ...
                  <div
                    className="h-24 w-24 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-2xl font-bold cursor-pointer"
                    onClick={openAvatarUploader}
                  >
                  ...
                  <div className="mt-4 flex justify-end space-x-3">
                    ...
                    {commission.status === "pending" && (
                      <>
                        <button
                          onClick={() =>
                            navigate(`/commissions/${commission._id}/accepted`)
                          }
                        ...
                        <button
                          onClick={() =>
                            navigate(`/commissions/${commission._id}/rejected`)
                          }
                    ...
                    {commission.status === "accepted" && (
                      <button
                        onClick={() =>
                          navigate(`/commissions/${commission._id}/completed`)
                        }
